...
* [geojson-jackson](https://github.com/opendatalab-de/geojson-jackson): serialize geojson to/from Java datatypes (based on [Jackson](http://wiki.fasterxml.com/JacksonHome))
* [mapbox-java](https://github.com/mapbox/mapbox-java): serialize geojson to/from Java datatypes (based on [Gson](https://github.com/google/gson))
