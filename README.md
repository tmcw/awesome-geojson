...
* [GeoJSON editor](https://tomscholz.github.io/geojson-editor/): a modified version of Googles [simple geojson editor](https://google-developers.appspot.com/maps/documentation/utils/geojson/).
